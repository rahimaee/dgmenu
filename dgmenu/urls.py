...
urlpatterns = [
    ...
    path('adminpanel/tabel/', include('adminpanel_cafe_tabel.urls', namespace='adminpanel_cafe_tabel')),
    ...
    path('', include('dgmenu_cafe_tabel.urls', namespace='dgmenu_cafe_tabel')),
