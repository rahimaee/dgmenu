    ...
    function addTaskBlockQB(){
      $(".ms-add-task-block").on('submit', function(e){
        ...
        $(".ms-quickbar-container .ms-todo-list").prepend(
          ...
          '<h6 class="ms-card-title">'+ $("#task-block").val() +'</h6> <button data-toggle="tooltip" data-placement="left" title="افزودن کار" class="ms-add-task-to-block ms-btn-icon float-right">' +
          '<i class="material-icons">add</i> </button> </div> <div class="ms-card-body"> <ul class="ms-list ms-task-block"> </ul></div>' +
          '<div class="ms-card-footer clearfix"><a href="#" class="text-disabled mr-2"> <i class="flaticon-archive"> </i> آرشیو </a><a href="#" class="text-disabled ms-delete-trigger float-right">' +
          '<i class="flaticon-trash"> </i> حذف</a> </div> </div>'
        );
      });
    }
    ...
    function addTaskBlockApp(){
      $(".ms-add-task-block-2").on('submit', function(e){
        ...
        $(".ms-todo-list").prepend(
          ...
          '<h6 class="ms-card-title">'+ $("#task-block-2").val() +'</h6> <button data-toggle="tooltip" data-placement="left" title="افزودن کار" class="ms-add-task-to-block ms-btn-icon float-right">' +
          '<i class="material-icons">add</i> </button> </div> <div class="ms-card-body"> <ul class="ms-list ms-task-block"> </ul></div>' +
          '<div class="ms-card-footer clearfix"><a href="#" class="text-disabled mr-2"> <i class="flaticon-archive"> </i> آرشیو </a><a href="#" class="text-disabled ms-delete-trigger float-right">' +
          '<i class="flaticon-trash"> </i> حذف</a> </div> </div> </div>'
        );
      });
    }
